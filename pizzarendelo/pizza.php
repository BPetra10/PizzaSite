...
<div class="container-fluid bg-1 text-center">
  ...
  <img src="Kepek/logo.png" class="img-responsive img-circle margin" style="display:inline" alt="Logo" title="Logo" width="350" height="350">
...
<div class="container-fluid bg-2 text-center">    
  ...
  <div class="row">
    <div class="col-xs-12 col-sm-4">
      ...
      <img src="Kepek/onarckep.jpg" class="img-responsive margin" style="width:100%;" alt="Önarckép" title="Önarckép">
    </div>
    <div class="col-xs-12 col-sm-4"> 
      <p class="info">Leglelkesebb pincérünk:</p>
      <img src="Kepek/pincer.png" class="img-responsive margin" style="width:100%;" alt="Hónap Pincére" title="Hónap Pincére">
    </div>
    <div class="col-xs-12 col-sm-4"> 
      <p class="info">Házhozszállító csapatunk:</p>
      <img src="Kepek/hazhoz.jpg" class="img-responsive margin" style="width:100%;" alt="Házhozszállítás" title="Házhozszállítás">
    </div>
  </div>
</div>
...
.bg-1 
{ 
    background-image: url(Kepek/pizzabackground.jpg); 
