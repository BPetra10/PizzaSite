...
<!--    Carousel Slider    -->
      <div class="carousel-inner" role="listbox">
        <div class="carousel-item active">
          <img src="Kepek/pizzagyuro.jpg" class="d-block w-100">
        ...
        <div class="carousel-item">
          <img src="Kepek/terasz.jpg" class="d-block w-100">
          <div class="carousel-caption">
            <h3>Éttermünk</h3>
        ...
        <div class="carousel-item">
          <img src="Kepek/nyitva.jpg" class="d-block w-100">
          <div class="carousel-caption">
        ...
        <div class="carousel-item">
          <img src="Kepek/utalvany.jpg" class="d-block w-100">
          <div class="carousel-caption">
